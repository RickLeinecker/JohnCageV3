            ...
            <div className='about-layout'>
                <div className='about-us-container'>
                    ...
                    <p className='about-us-body'>
                        We, the developers, are students from the University of Central Florida.
                        This is the third version of the John Cage Tribute Senior Design Project.
                        With this project we want to show people that "Everything we do is music." - John Cage.
                        We worked closely with our Sponsor Richard Leinecker to develop
                        an application that can be used by anyone to make music.
                    </p>
                </div>
